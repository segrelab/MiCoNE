...
if __name__ == "__main__":
    OTU_FILE = "${otu_file}"
    COUNT_THRES = int("${params.abundance.count_thres}")
    PREVALENCE_THRES = float("${params.abundance.prevalence_thres}")
    ABUNDANCE_THRES = float("${params.abundance.abundance_thres}")
